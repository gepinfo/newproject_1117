...
{ path : '/productlist', component: lazy(()=>import('./app/productlist/productlist')) },
{ path : '/productupdate', component: lazy(()=>import('./app/productupdate/productupdate')) },
{ path : '/productcreate', component: lazy(()=>import('./app/productcreate/productcreate')) },
